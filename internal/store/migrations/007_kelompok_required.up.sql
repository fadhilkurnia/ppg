-- Tighten students.kelompok to NOT NULL. Every active row should already
-- have a kelompok assigned by this point; if any are still NULL the rebuild
...
ALTER TABLE students RENAME TO students_old_007;
...
SELECT id, name, nickname, date_of_birth, gender, level, kelompok,
       joined_at, left_at, leave_reason, status,
       parent_name, parent_phone, parent_email, created_at, updated_at
  FROM students_old_007;

DROP TABLE students_old_007;
