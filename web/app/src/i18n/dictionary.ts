...
export const id = {
  ...
  absen: {
    ...
    successMsg: 'Notifikasi WhatsApp sedang dikirim ke admin{{phone}}.',
    successWithPhone: ' dan nomor Anda',
...
export const en: Dict = {
  ...
  absen: {
    ...
    successMsg: 'A WhatsApp notification is being sent to the admin{{phone}}.',
    successWithPhone: ' and to your number',
